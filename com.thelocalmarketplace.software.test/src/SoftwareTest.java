...
//        software.addBarcodedProductToOrder(testProduct);
...
//        software.addProduct(testProduct);
//        software.addBaggedProduct(testProduct);
//        //Assert that it was added to BarcodedProductsinOrder
//        assertTrue(software.getBarcodedProductsInOrder().contains(testProduct));
//        assertTrue(software.getBaggedProducts().contains(testProduct));
//        //Call
//        software.removeBarcodedProduct(testProduct);
//        //Assert that test product has been removed
//        assertFalse(software.getBarcodedProductsInOrder().contains(testProduct));
//        assertFalse(software.getBaggedProducts().contains(testProduct));
...
//
//        //Add to barcodedProductsinOrder AND Bagged Product
//        software.addProduct(testProduct1);
//        software.addBaggedProduct(testProduct1);
//        software.addProduct(testProduct2);
//        software.addBaggedProduct(testProduct2);
//        //Call
//        software.removeBarcodedProduct(testProduct1);
